...
<head>
<style type="text/css">
	.button {border: 1px solid #000; margin: 10px; background-color: #8fbc8f;color: #003300;border-radius: 5%;min-width:200px;text-decoration: none;display: inline-block;padding: 8px 16px;}
</style>
